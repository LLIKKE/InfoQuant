...
import transformers
from infoquant.models.loading import load_rotated_model
from infoquant.models.llama_patched import LlamaForCausalLM
from infoquant.pipelines import evaluation as eval_utils
from infoquant.config.args import process_args_ptq
from transformers import AutoTokenizer
from infoquant.calibration.data import (
    load_or_create_calibration_loader,
    load_or_create_wikitext_eval,
)

from termcolor import colored
import pprint
import warnings
from infoquant.calibration.activation_capture import hook_Activation
from infoquant.rotation.optimizer import optimize_rotation_matrix
from infoquant.calibration.outlier_masks import Mask_token
...
def run_psot() -> None:
    ...
    trainloader = load_or_create_calibration_loader(args, logger)
    ...
    model.config.use_cache = False
    testloader = load_or_create_wikitext_eval(args, tokenizer, logger)
